...
initval;
	A	=	1.0;
	C	=	0.950579824954767;
	MC	=	0.888888888893562;
	M_real	=	0.9152363832330541;
	N	=	0.9346552651848885;
	Pi	=	1.000000000009087;
	Pi_star	=	1.0000000000272609;
	Q	=	0.9899999999923135;
	R	=	1.010101010116947;
	S	=	1.0;
	W_real	=	0.6780252644071325;
	Y	=	0.9505798249547674;
	Z	=	1.0;
	i_ann	=	0.04020134347711578;
	log_A	=	0.0;
	log_N	=	-0.0675775180171486;
	log_W_real	=	-0.38857072859863134;
	log_Z	=	0.0;
	log_y	=	-0.05068313851286125;
	nu	=	0.0;
	pi_ann	=	3.634781364764278e-11;
	r_real_ann	=	0.0402013434407683;
	realinterest	=	1.0101010101077683;
	x_aux_1	=	3.4519956863259393;
	x_aux_2	=	3.883495146694363;
end;
