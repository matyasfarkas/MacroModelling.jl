...
using StatsBase
RN_filtered_epsgskewed = zeros(simnumb,80)
RN_filtered_epsrskewed = zeros(simnumb,80)
RN_filtered_epszskewed = zeros(simnumb,80)

shocksim =zeros(4,80,simnumb,3)
...
StatsPlots.density!(vec(shocksim[1,:,:,1]),dims=1, legend = false) # antithetic shocks
