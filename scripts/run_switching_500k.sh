#!/bin/bash
#
# 500K regime-switching estimation for paper results
#
...
OUT=".local_artifacts/hlt_18param_realdata/hlt_switching_inversion_chain_500k.jls"

mkdir -p .local_artifacts/logs

echo "==============================================="
echo "500K REGIME-SWITCHING ESTIMATION"
echo "Started: $(date)"
echo "==============================================="
