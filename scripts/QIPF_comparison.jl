...
key_vars = [:Y_D, :PI_C, :I, :C, :G, :B]

println("="^70)
println("QIPF IRF COMPARISON: PERTURBATION ORDERS vs SEP")
println("="^70)
println("Shock: $(shock)")
...
pdf_path = joinpath(@__DIR__, "QIPF_comparison_sep_irf.pdf")
savefig(p, pdf_path)
