...
open(md_path, "w") do io
    ...
    println(io)
    println(io, "| Family | Chain | Init source | Draws | Log criterion at mean | Divergences | Acceptance rate | sigma_a | sigma_b | sigma_qs | rho_b | rho_w | phi_p |")
    println(io, "|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|")
    for r in rows
...
open(tex_path, "w") do io
    ...
    println(io, "\\toprule")
    println(io, "Family & Chain & Initialization & Log criterion & Divergences & Acceptance rate & \$\\sigma_a\$ & \$\\sigma_b\$ & \$\\sigma_{qs}\$ \\\\")
    println(io, "\\midrule")
    for r in rows
    ...
    println(io, "% Notes: Existing chain records only; use with the Rhat diagnostics.")
end
