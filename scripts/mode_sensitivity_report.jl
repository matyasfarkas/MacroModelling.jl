...
const ARTIFACT_DIR = parse_kv_string(ARGS, "--out-dir",
    joinpath(REPO_ROOT, ".local_artifacts", "mode_sensitivity"))
const CHAIN_DIR = joinpath(REPO_ROOT, ".local_artifacts", "hlt_18param_realdata")

const CHAIN_SPECS = [
    ("Kalman", "Linear, seed 99", "Calibrated interior", "hlt_linear_hmc_extended_18p_2000.jls"),
    ("Kalman", "Linear, seed 3",  "Calibrated interior", "hlt_linear_hmc_extended_18p_2000_seed3.jls"),
    ("Kalman", "Linear, seed 4",  "Calibrated interior", "hlt_linear_hmc_extended_18p_2000_seed4.jls"),
    ("Kalman", "Linear, seed 5",  "Calibrated interior", "hlt_linear_hmc_extended_18p_2000_seed5.jls"),
    ("Surrogate", "Cold start, seed 2", "Calibrated interior", "hlt_surrogate_hmc_extended_18p_2000_seed2.jls"),
    ("Surrogate", "Cold start, seed 3", "Calibrated interior", "hlt_surrogate_hmc_extended_18p_2000_seed3.jls"),
    ("Surrogate", "Cold start, seed 4", "Calibrated interior", "hlt_surrogate_hmc_extended_18p_2000_seed4.jls"),
    ("Surrogate", "Warm start, seed 42", "Linear posterior mean", "hlt_surrogate_hmc_extended_18p_2000.jls"),
    ("Surrogate", "Warm start, seed 5",  "Linear posterior mean", "hlt_surrogate_hmc_extended_18p_2000_seed5.jls"),
    ("Surrogate", "Warm start, seed 6",  "Linear posterior mean", "hlt_surrogate_hmc_extended_18p_2000_seed6.jls"),
    ("Surrogate", "Warm start, seed 7",  "Linear posterior mean", "hlt_surrogate_hmc_extended_18p_2000_seed7.jls"),
]
...
open(md_path, "w") do io
    ...
    println(io)
    println(io, "| Family | Chain | Init source | Draws | Criterion value at mean | Divergences | Acceptance rate | sigma_a | sigma_b | sigma_qs | rho_b | rho_w | phi_p |")
    println(io, "|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|")
    for r in rows
...
open(tex_path, "w") do io
    println(io, "% Generated by scripts/mode_sensitivity_report.jl")
    println(io, "\\begin{tabular}{lllrrrrrrr}")
    println(io, "\\toprule")
    println(io, "Family & Chain & Initialization & Criterion value & Divergences & Acceptance rate & \$\\sigma_a\$ & \$\\sigma_b\$ & \$\\sigma_{qs}\$ \\\\")
    println(io, "\\midrule")
    for r in rows
