...
@model QMIPF_stoch begin
	...
	I[0] = (1 - psi_i) * (SS_I + psi_pi * (PI_C[0] - SS_PI_C) + psi_pid * (PI_D[0] - SS_PI_D) + psi_x * (Y[0] / Y_POT[0] - 1)) + psi_i * I[-1] + E_I[0] #max(elb, (1 - psi_i) * (SS_I + psi_pi * (PI_C[0] - SS_PI_C) + psi_pid * (PI_D[0] - SS_PI_D) + psi_x * (Y[0] / Y_POT[0] - 1)) + psi_i * I[-1] + E_I[0]) #psi_theta * THETA[0] +
	...
	I_ST[0] = (1 - psi_i_ST) * (SS_I_ST + psi_pi_ST * (PI_C_ST[0] - SS_PI_C_ST) + psi_pid_ST * (PI_D_ST[0] - SS_PI_D_ST) + psi_x_ST * (Y_ST[0] / Y_ST_POT[0] - 1)) + psi_i_ST * I_ST[-1] + E_I_ST[0] #max(elb_ST,(1 - psi_i_ST) * (SS_I_ST + psi_pi_ST * (PI_C_ST[0] - SS_PI_C_ST) + psi_pid_ST * (PI_D_ST[0] - SS_PI_D_ST) + psi_x_ST * (Y_ST[0] / Y_ST_POT[0] - 1)) + psi_i_ST * I_ST[-1] + E_I_ST[0])
	...
	log((1 + tau_w) / UPSILON_W[0]) = rho_upsilon_w * log((1 + tau_w) / UPSILON_W[-1]) + 0.0 * EPS_UPSILON_W[x] + 0.0 * spill_upsilon_w * EPS_UPSILON_W_ST[x]
	...
	log((1 + tau_w) / UPSILON_W_ST[0]) = 0.0 * EPS_UPSILON_W_ST[x] + rho_upsilon_w_ST * log((1 + tau_w) / UPSILON_W_ST[-1])
	...
	TAU_F[0] - SS_TAU_F = ( - ppsif_b) * (B[0] - SS_B) / SS_Y + EPS_TAU_F[x] #max(0.0,( - ppsif_b) * (B[0] - SS_B) / SS_Y) + EPS_TAU_F[x]
