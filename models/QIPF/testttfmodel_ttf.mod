...
I=psi_theta*THETA +(1-psi_i)*(SS_I+psi_pi*(PI_C-SS_PI_C)+psi_pid*(PI_D-SS_PI_D))+psi_i*I(-1)+E_I; // Equation 44
%I=psi_theta*THETA +(1-psi_i)*(SS_I+psi_pi*(PI_C-SS_PI_C)+psi_pid*(PI_D-SS_PI_D)+psi_x*(Y/SS_Y-1))+psi_i*I(-1)+E_I; // Equation 44
...
I_ST=(1-psi_i_ST)*(SS_I_ST+psi_pi_ST*(PI_C_ST-SS_PI_C_ST)+psi_pid_ST*(PI_D_ST-SS_PI_D_ST))+psi_i_ST*I_ST(-1)+E_I_ST; // Equation 88
%I_ST=(1-psi_i_ST)*(SS_I_ST+psi_pi_ST*(PI_C_ST-SS_PI_C_ST)+psi_pid_ST*(PI_D_ST-SS_PI_D_ST)+psi_x_ST*(Y_ST/SS_Y_ST-1))+psi_i_ST*I_ST(-1)+E_I_ST; // Equation 88
...
stoch_simul(order=3,pruning,k_order_solver,irf=40) C C_ST Y Y_ST Y_D Y_D_ST Y_M Y_M_ST Q PI_C PI_C_ST B;
