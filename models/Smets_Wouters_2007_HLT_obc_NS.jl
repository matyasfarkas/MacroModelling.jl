# HLT model variant: Nakamura-Steinsson pricing slope (ARRS QJE 2024)
# Identical to baseline HLT_obc except:
#   curvp = 1   (CES aggregation, no Kimball kink — matches ARRS specification)
#   cprobp = 0.17 (calibrated to produce NS slope kappa ≈ 0.47)

@model Smets_Wouters_2007_HLT_obc_NS begin
...
@parameters Smets_Wouters_2007_HLT_obc_NS simplify = false begin
	...
	cprobp = 0.17       # Nakamura-Steinsson slope: kappa ≈ 0.47 (ARRS QJE 2024, Table V)
