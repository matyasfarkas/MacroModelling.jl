# HLT model variant: Golosov-Lucas pricing slope (ARRS QJE 2024)
# Identical to baseline HLT_obc except:
#   curvp = 1   (CES aggregation, no Kimball kink — matches ARRS specification)
#   cprobp = 0.034 (calibrated to produce GL slope kappa ≈ 1.71)

@model Smets_Wouters_2007_HLT_obc_GL begin
...
@parameters Smets_Wouters_2007_HLT_obc_GL simplify = false begin
	...
	cprobp = 0.034      # Golosov-Lucas slope: kappa ≈ 1.71 (ARRS QJE 2024, Table V)
